    ...
    tips: [
      {
        ...
        descriptionLines: [
          ...
          '<ul><li>37.5度の熱はありませんか？</li></ul>',
          '<ul><li>咳をしていませんか？</li></ul>'
        ]
      },
      {
        ...
        descriptionLines: [
          ...
          '<ul><li>部屋の換気をする。目安は1日3回、1回につき20〜30分</li></ul>',
          '<ul><li>他人との距離は2メートル以上開ける</li></ul>',
          '<ul><li>75%アルコールを使い、身の回りの機器の消毒する（会議室や公用車などの共用スペース、パソコンや固定電話など）</li></ul>',
          '<ul><li>トイレの後と食事の前は、特に念入りに手洗いする</li></ul>'
        ]
      },
      {
